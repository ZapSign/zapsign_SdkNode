...
const docFromTemplate = new DocFromTemplate(true, 'My New Doc From Template', 'pt-br', true, false, '', '', '', '', './', new Date(), false, [], [new Signer('', '', '', false, false, 0, '', '', '', false, false, false, false, false, false, false, false, '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '')], 0, 'Signer Name', '493e86dd-0427-40dd-99d4-2a5113bd896e', deParaTemplates)
